...
<body>
 ...
 %>
		...
		<button type="button" onclick="location.href='insertPollForm.jsp'"
			style="background-color: #007bff; color: white; border: none; padding: 10px 20px; font-size: 16px; border-radius: 5px; cursor: pointer; transition: 0.3s;">
			등록</button>
		<div class="pagination">
			...
			%>
			<a href="?currentPage=<%=prevPage%>">이전</a> <a
				href="?currentPage=<%=nextPage%>">다음</a>
		</div>
	</div>
</body>
</html>
